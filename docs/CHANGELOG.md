...
* sap\.sap\_operations\.valid\_fqdn \- Verify that value provided is valid fqdn
* sap\.sap\_operations\.valid\_hostname \- Return true if string provided is valid sap hostname as per SAP note 611361
